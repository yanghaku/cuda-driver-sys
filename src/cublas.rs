...
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct cublasLtMatrixLayoutStruct {
    _unused: [u8; 0],
}
pub type cublasLtMatrixLayout_t = *mut cublasLtMatrixLayoutStruct;
#[repr(C)]
...
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct cublasLtMatmulDescStruct {
    _unused: [u8; 0],
}
pub type cublasLtMatmulDesc_t = *mut cublasLtMatmulDescStruct;
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct cublasLtMatrixTransformDescStruct {
    _unused: [u8; 0],
}
pub type cublasLtMatrixTransformDesc_t = *mut cublasLtMatrixTransformDescStruct;
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct cublasLtMatmulPreferenceStruct {
    _unused: [u8; 0],
}
pub type cublasLtMatmulPreference_t = *mut cublasLtMatmulPreferenceStruct;
#[repr(u32)]
#[derive(Debug, Copy, Clone, Hash, PartialOrd, Ord, PartialEq, Eq)]
